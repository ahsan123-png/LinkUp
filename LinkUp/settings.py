...
SECRET_KEY = 'django-insecure-1p*rf4v^33aems3sfv-j6ehqyxqwrn1x&bcdnzkt5gtqlb8ad!'
DEBUG = True
ALLOWED_HOSTS = []
INSTALLED_APPS = [
    'daphne',
...
# Optionally configure JWT settings (these are defaults):
...
CORS_ALLOWED_ORIGINS = [
    "http://localhost:5500",  # Or your frontend domain
